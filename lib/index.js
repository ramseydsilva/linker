...
var Crawler = function(options) {
    ...
    this.processLink = function(link) {
        ...
        if (link.reason) {
            ...
            // About to crawl, so marked as crawled to avoid recrawling
            this.crawledLinks.push(link.href);
    ...
    this._crawl = function(website) {
        ...
        .then(function(res) {
            ...
            this.promise.progress({type: 'crawled', url: website.href});
        ...
        .catch(function(err) {
            ...
            if (err[0] && err[0].data) console.log('Data: ', err[0].data);
            promise.resolve();
        });
